...
class AddDoctorActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    private fun addDoctor() {
        ...
        retrofitObj.addDoctor(DoctorItem(0,addDoctorViewModel.name,addDoctorViewModel.specializationId,addDoctorViewModel.specialzation,addDoctorViewModel.phoneNumber))
