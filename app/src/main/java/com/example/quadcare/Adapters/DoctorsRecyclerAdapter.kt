...
class DoctorsRecyclerAdapter(var listData: ArrayList<DoctorItem>, var mListner:doctorAdapterListner): RecyclerView.Adapter<DoctorsRecyclerAdapter.ViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.doctorName.text = listData[position].name.toString()
        holder.doctorSp.text = listData[position].specialization.toString()
        holder.doctorShift.text = "10:00 am to 8:00 pm"
